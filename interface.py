...
class Application(ttk.Frame):
    ...
    def __init__(self, main_window):
        ...
        # custom layout
        self.frame = tk.Frame(main_window, width=500)
        ...
        self.file_image = tk.PhotoImage(file="static/file.png")
        self.folder_image = tk.PhotoImage(file="static/folder.png")
        
        # Cargar el directorio raíz.
        # self.load_tree(abspath(sep))
        self.load_tree(f"{getcwd()}/images")
